...
const size_t TCHAT_POSITION_TEMP_HUM_PIN = TCHAT_TYPE_POSITION + 1;
const size_t TCHAT_POSITION_TEMP_HUM_TEMPERATURE_VALUE = TCHAT_POSITION_TEMP_HUM_PIN + 1;
const size_t TCHAT_POSITION_TEMP_HUM_HUMIDITY_VALUE = TCHAT_POSITION_TEMP_HUM_TEMPERATURE_VALUE + 1;
